yahwehShammah.pages.push({
    ...
    main() {
        ...
        db
        .filter(({numero})=>yahwehShammah.favoritos.get().includes(+numero))
    ...
    showLyric(numero_do_hino) {
        ...
        let favorito = yahwehShammah.favoritos.get(+numero).includes(+numero) ? 'accent' : 'toned'
        ...
        document.querySelector('#next').addEventListener('click', (event)=> {
            let f = yahwehShammah.favoritos.get()
